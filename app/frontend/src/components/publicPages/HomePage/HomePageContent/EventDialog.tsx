...
const EventDialog: React.FC<{
    ...
    const handleCreateIssueClick = () => {
        if (event) {
            navigate(`/events/${encodeURIComponent(event.name)}/report-issue`);
        }
    };
    ...
    return (
        <Dialog open={open} onClose={onClose} fullWidth maxWidth="sm">
            ...
            <DialogContent>
                {event ? (
                    <>
                        ...
                        <p>
                            <strong>Location:</strong> {`${event.location.street}, ${event.location.number}, ${event.location.postalCode}`}
                        </p>
            ...
            <DialogActions>
                ...
                <Button onClick={handleCreateIssueClick} color="secondary" variant="outlined">
                    Report Issue
                </Button>
            </DialogActions>
        </Dialog>
